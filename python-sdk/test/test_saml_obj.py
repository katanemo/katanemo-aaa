...
import katanemo_sdk
from katanemo_sdk.models.saml_obj import SAMLObj  # noqa: E501
...
class TestSAMLObj(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = katanemo_sdk.models.saml_obj.SAMLObj()  # noqa: E501
        if include_optional :
            return SAMLObj(
                connection_id = '', 
                id_provider = '', 
                ...
                attribute_role_mappings = [
                    katanemo_sdk.models.attribute_role_mapping.AttributeRoleMapping(
                        attribute = '', 
                        value = '', 
                        role_id = '', )
                    ], 
