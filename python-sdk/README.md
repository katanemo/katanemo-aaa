...
*DefaultApi* | [**authorize**](docs/DefaultApi.md#authorize) | **GET** /authorize | Initiate the login flow by redirecting to login page
*DefaultApi* | [**post_authorize**](docs/DefaultApi.md#post_authorize) | **POST** /arc/authorize | dummy endpoint for authorize
