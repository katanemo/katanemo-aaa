...
class NotFoundException(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotFoundException:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotFoundException:
        """Create an instance of NotFoundException from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotFoundException.parse_obj(obj)

        _obj = NotFoundException.parse_obj({
