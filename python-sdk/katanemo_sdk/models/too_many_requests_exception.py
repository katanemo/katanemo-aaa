...
class TooManyRequestsException(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TooManyRequestsException:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TooManyRequestsException:
        """Create an instance of TooManyRequestsException from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TooManyRequestsException.parse_obj(obj)

        _obj = TooManyRequestsException.parse_obj({
