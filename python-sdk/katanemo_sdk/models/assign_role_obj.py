...
class AssignRoleObj(BaseModel):
    ...
    __properties = ["principalId", "roleId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssignRoleObj:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssignRoleObj:
        """Create an instance of AssignRoleObj from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AssignRoleObj.parse_obj(obj)

        _obj = AssignRoleObj.parse_obj({
