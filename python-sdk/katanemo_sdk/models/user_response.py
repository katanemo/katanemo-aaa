...
class UserResponse(BaseModel):
    ...
    UserResponse
    """
    account_id: StrictStr = Field(..., alias="accountId", description="Organization Identifier for a SaaS customer")
    service_id: Optional[StrictStr] = Field(None, alias="serviceId", description="Service which this account subscribed to")
    user_id: Optional[StrictStr] = Field(None, alias="userId", description="Email")
