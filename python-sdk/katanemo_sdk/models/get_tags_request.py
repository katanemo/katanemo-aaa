...
class GetTagsRequest(BaseModel):
    ...
    __properties = ["resourceName", "resourceId", "accountId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTagsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTagsRequest:
        """Create an instance of GetTagsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTagsRequest.parse_obj(obj)

        _obj = GetTagsRequest.parse_obj({
