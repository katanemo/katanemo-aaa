...
class AttributeRoleMapping(BaseModel):
    ...
    __properties = ["attribute", "value", "roleId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeRoleMapping:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeRoleMapping:
        """Create an instance of AttributeRoleMapping from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttributeRoleMapping.parse_obj(obj)

        _obj = AttributeRoleMapping.parse_obj({
