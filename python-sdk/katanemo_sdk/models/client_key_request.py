...
class ClientKeyRequest(BaseModel):
    ...
    __properties = ["defaultRoleId", "clientName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientKeyRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientKeyRequest:
        """Create an instance of ClientKeyRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientKeyRequest.parse_obj(obj)

        _obj = ClientKeyRequest.parse_obj({
