...
# body param
SchemaForRequestBodyApplicationJson = AttributeRoleMapping


request_body_attribute_role_mapping = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SAMLObj
...
SchemaFor400ResponseBodyApplicationJson = BadRequestException
...
SchemaFor401ResponseBodyApplicationJson = UnauthorizedException
...
SchemaFor409ResponseBodyApplicationJson = ConflictException
...
SchemaFor429ResponseBodyApplicationJson = TooManyRequestsException
...
SchemaFor500ResponseBodyApplicationJson = InternalServerErrorException
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_saml_connection_mapping_oapg(
        self,
    ...
    def _create_saml_connection_mapping_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_attribute_role_mapping.serialize(body, content_type)
...
class CreateSamlConnectionMapping(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_saml_connection_mapping(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def create_saml_connection_mapping(
        ...
        return self._create_saml_connection_mapping_oapg(
            body=body,
