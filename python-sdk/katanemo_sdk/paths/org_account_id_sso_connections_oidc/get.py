...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OIDCObj']:
            return OIDCObj

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OIDCObj'], typing.List['OIDCObj']],
    ...
    def __getitem__(self, i: int) -> 'OIDCObj':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_oidc_connections_for_account_oapg(
        self,
...
class GetOidcConnectionsForAccount(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_oidc_connections_for_account(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_oidc_connections_for_account(
        ...
        return self._get_oidc_connections_for_account_oapg(
