...
# body param
SchemaForRequestBodyApplicationJson = OIDCObj


request_body_oidc_obj = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OIDCObj
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_oidcc_onnection_oapg(
        self,
    ...
    def _create_oidcc_onnection_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_oidc_obj.serialize(body, content_type)
...
class CreateOidccOnnection(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_oidcc_onnection(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def create_oidcc_onnection(
        ...
        return self._create_oidcc_onnection_oapg(
            body=body,
