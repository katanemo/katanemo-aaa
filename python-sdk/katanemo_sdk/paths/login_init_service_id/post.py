...
# body param
SchemaForRequestBodyApplicationJson = InitialLoginRequest


request_body_initial_login_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = InitialLoginResponse
...
class BaseApi(api_client.Api):
    ...
    def _login_init_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_initial_login_request.serialize(body, content_type)
