...
# body param
SchemaForRequestBodyApplicationJson = AssumeRoleObj


request_body_assume_role_obj = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _assume_role_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_assume_role_obj.serialize(body, content_type)
