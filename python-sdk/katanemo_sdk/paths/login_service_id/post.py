...
# body param
SchemaForRequestBodyApplicationJson = LoginWithPasswordRequest


request_body_login_with_password_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = LoginToken
...
class BaseApi(api_client.Api):
    ...
    def _login_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_login_with_password_request.serialize(body, content_type)
