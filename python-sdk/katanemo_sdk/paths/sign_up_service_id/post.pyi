...
# body param
SchemaForRequestBodyApplicationJson = SignupRequest


request_body_signup_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _service_signup_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_signup_request.serialize(body, content_type)
...
class ServiceSignup(BaseApi):
    ...
    def service_signup(
        ...
        return self._service_signup_oapg(
            body=body,
