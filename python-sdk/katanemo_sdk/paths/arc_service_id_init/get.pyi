...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['InitArcResponse']:
            return InitArcResponse

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['InitArcResponse'], typing.List['InitArcResponse']],
    ...
    def __getitem__(self, i: int) -> 'InitArcResponse':
...
class InitArcClient(BaseApi):
    ...
    def init_arc_client(
        ...
        return self._init_arc_client_oapg(
