...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ServiceResponseObj']:
            return ServiceResponseObj

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ServiceResponseObj'], typing.List['ServiceResponseObj']],
    ...
    def __getitem__(self, i: int) -> 'ServiceResponseObj':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_services_by_developer_oapg(
        self,
...
class ListServicesByDeveloper(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_services_by_developer(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def list_services_by_developer(
        ...
        return self._list_services_by_developer_oapg(
