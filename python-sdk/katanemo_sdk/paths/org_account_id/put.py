...
# body param
SchemaForRequestBodyApplicationJson = UpdateOrganizationRequest


request_body_update_organization_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_account_info_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_organization_request.serialize(body, content_type)
