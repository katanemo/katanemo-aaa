...
# body param
SchemaForRequestBodyApplicationJson = SetPasswordRequest


request_body_set_password_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_password_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_set_password_request.serialize(body, content_type)
...
class SetPassword(BaseApi):
    ...
    def set_password(
        ...
        return self._set_password_oapg(
            body=body,
