...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RoleResponse']:
            return RoleResponse

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['RoleResponse'], typing.List['RoleResponse']],
    ...
    def __getitem__(self, i: int) -> 'RoleResponse':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_roles_for_service_oapg(
        self,
...
class GetRolesForService(BaseApi):
    ...
    def get_roles_for_service(
        ...
        return self._get_roles_for_service_oapg(
