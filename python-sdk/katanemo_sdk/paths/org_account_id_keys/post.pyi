...
# body param
SchemaForRequestBodyApplicationJson = ClientKeyRequest


request_body_client_key_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ClientKeyResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_client_key_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_client_key_request.serialize(body, content_type)
...
class CreateClientKey(BaseApi):
    ...
    def create_client_key(
        ...
        return self._create_client_key_oapg(
            body=body,
