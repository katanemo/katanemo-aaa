...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ClientKeyObject']:
            return ClientKeyObject

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ClientKeyObject'], typing.List['ClientKeyObject']],
    ...
    def __getitem__(self, i: int) -> 'ClientKeyObject':
...
class GetClientKeyList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_client_key_list(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_client_key_list(
        ...
        return self._get_client_key_list_oapg(
