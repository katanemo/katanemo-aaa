...
# body param
SchemaForRequestBodyApplicationJson = OAuthTokenRequest


request_body_o_auth_token_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OAuthTokenResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_o_auth_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_o_auth_token_request.serialize(body, content_type)
...
class GetOAuthToken(BaseApi):
    ...
    def get_o_auth_token(
        ...
        return self._get_o_auth_token_oapg(
            body=body,
