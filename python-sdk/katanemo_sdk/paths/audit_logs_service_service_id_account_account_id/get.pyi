...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['AuditLogEntry']:
            return AuditLogEntry

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['AuditLogEntry'], typing.List['AuditLogEntry']],
    ...
    def __getitem__(self, i: int) -> 'AuditLogEntry':
...
class GetAuditLogs(BaseApi):
    ...
    def get_audit_logs(
        ...
        return self._get_audit_logs_oapg(
