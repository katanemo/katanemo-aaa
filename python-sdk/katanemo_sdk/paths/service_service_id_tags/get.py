...
# body param
SchemaForRequestBodyApplicationJson = GetTagsRequest


request_body_get_tags_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Tags
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_tags_for_resource_oapg(
        self,
    ...
    def _get_tags_for_resource_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_get_tags_request.serialize(body, content_type)
...
class GetTagsForResource(BaseApi):
    ...
    def get_tags_for_resource(
        ...
        return self._get_tags_for_resource_oapg(
            body=body,
