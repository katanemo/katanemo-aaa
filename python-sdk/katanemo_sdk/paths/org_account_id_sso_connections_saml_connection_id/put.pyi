...
# body param
SchemaForRequestBodyApplicationJson = SAMLObj


request_body_saml_obj = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_saml_connection_oapg(
        self,
    ...
    def _update_saml_connection_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_saml_obj.serialize(body, content_type)
...
class UpdateSamlConnection(BaseApi):
    ...
    def update_saml_connection(
        ...
        return self._update_saml_connection_oapg(
            body=body,
