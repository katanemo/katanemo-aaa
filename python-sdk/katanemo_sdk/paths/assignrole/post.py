...
# body param
SchemaForRequestBodyApplicationJson = AssignRoleObj


request_body_assign_role_obj = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _assign_role_to_principal_oapg(
        self,
    ...
    def _assign_role_to_principal_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_assign_role_obj.serialize(body, content_type)
...
class AssignRoleToPrincipal(BaseApi):
    ...
    def assign_role_to_principal(
        ...
        return self._assign_role_to_principal_oapg(
            body=body,
