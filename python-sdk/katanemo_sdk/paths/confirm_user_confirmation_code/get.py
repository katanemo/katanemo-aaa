...
# Path params
ConfirmationCodeSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'confirmationCode': typing.Union[ConfirmationCodeSchema, str, ],
    }
)
...
request_path_confirmation_code = api_client.PathParameter(
    name="confirmationCode",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ConfirmationCodeSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = UserConfirmationResponse
...
class BaseApi(api_client.Api):
    ...
    def _confirm_user_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_confirmation_code,
        ):
...
class ConfirmUser(BaseApi):
    ...
    def confirm_user(
        ...
        return self._confirm_user_oapg(
