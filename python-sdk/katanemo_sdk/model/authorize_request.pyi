...
class AuthorizeRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["clientId", "state", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["clientId", "state", ], str]):
