...
class RoleRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accountId", "rolename", "serviceId", "policy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accountId", "rolename", "serviceId", "policy", ], str]):
