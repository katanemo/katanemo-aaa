...
class RoleResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accountId", "roleId", "rolename", "description", "serviceId", "policy", "version", "updatedAt", "createdAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accountId", "roleId", "rolename", "description", "serviceId", "policy", "version", "updatedAt", "createdAt", ], str]):
