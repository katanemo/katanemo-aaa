...
class GetTagsRequest(
    ...
    resourceName: MetaOapg.properties.resourceName
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["resourceName", "resourceId", "accountId", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resourceName"]) -> MetaOapg.properties.resourceName: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["resourceName", "resourceId", "accountId", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        resourceName: typing.Union[MetaOapg.properties.resourceName, str, ],
