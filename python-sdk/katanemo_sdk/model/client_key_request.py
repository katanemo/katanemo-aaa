...
class ClientKeyRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["defaultRoleId", "clientName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["defaultRoleId", "clientName", ], str]):
