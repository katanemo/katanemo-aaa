...
class AssumeRoleObj(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["principalId", "roleId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["principalId", "roleId", ], str]):
