...
class UnauthorizedException(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnauthorizedException:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnauthorizedException:
        """Create an instance of UnauthorizedException from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnauthorizedException.parse_obj(obj)

        _obj = UnauthorizedException.parse_obj({
