...
class UpdateServiceRequest(BaseModel):
    ...
    """
    name: Optional[StrictStr] = Field(None, description="Service Name")
    description: Optional[StrictStr] = Field(None, description="Service Description")
    redirect_url: Optional[StrictStr] = Field(None, alias="redirectUrl", description="Redirect URL after a successful login.")
    api_spec_file: Optional[Union[StrictBytes, StrictStr]] = Field(None, alias="apiSpecFile", description="openapi service json or yaml file")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateServiceRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateServiceRequest:
        """Create an instance of UpdateServiceRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateServiceRequest.parse_obj(obj)

        _obj = UpdateServiceRequest.parse_obj({
            "name": obj.get("name"),
